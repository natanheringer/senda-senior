  ...
  return (
    <section style={{
      ...
      <div style={{ position: 'absolute', top: '-30%', right: '-15%', zIndex: 1, opacity: 0.05 }}>
         <Compass size={1200} strokeWidth={1.5} color="var(--green)" style={{ animation: 'spin 120s linear infinite' }} />
      </div>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 580 }}>
          ...
          <Reveal delay={0.15}>
            <h1 style={{
              fontFamily: 'var(--serif)', fontSize: 'clamp(44px, 5vw, 68px)',
              fontWeight: 500, lineHeight: 1.05, letterSpacing: '-0.02em',
              color: 'var(--text)', marginBottom: 0,
            }}>
              Senda Sênior: <br />
              <em style={{ fontStyle: 'italic', color: 'var(--green)' }}>Uma Jornada de Cuidado e Independência.</em>
            </h1>
            <div className="line-terracota" />
          </Reveal>
          <Reveal delay={0.3}>
            <p style={{
              fontFamily: 'var(--sans)', fontSize: 'clamp(17px, 1.8vw, 21px)',
              fontWeight: 400, lineHeight: 1.65, color: 'var(--text-sub)',
          ...
          <Reveal delay={0.42}>
            <p style={{
              ...
              "Cada toque é natural e acolhedor."
            </p>
          </Reveal>
          <Reveal delay={0.55}>
            <div className="hero-buttons" style={{ display: 'flex', gap: 16 }}>
              <a href="/manual/apresentacao" id="hero-cta-primary" data-cursor="Ler Agora" style={{
              ...
              <a href="#contato" id="hero-cta-secondary" data-cursor="Contato" style={{
                background: 'rgba(255,255,255,0.65)', color: 'var(--green)',
                padding: '17px 36px', borderRadius: 10,
                fontSize: 16, fontWeight: 600, textDecoration: 'none',
                border: '1.5px solid var(--green)', transition: 'all 0.3s',
        ...
        <Reveal delay={0.7}>
          <div className="hero-testimonial" style={{
            ...
            <p style={{
              ...
              color: 'var(--green)', marginBottom: 10, letterSpacing: '0.02em',
            }}>
            ...
            <p style={{
              ...
              "Decisões tomadas com calma sempre protegem melhor do que decisões tomadas na pressa."
            </p>
          </div>
        </Reveal>
      </div>
