...
function PilarSection({ label, title, text, index, image, imageAlt, icon }: {
  label: string; title: string; text: string; index: number;
  ...
  return (
    <div style={{
      ...
      background: isEven ? 'var(--warm-white)' : 'var(--cream)',
    }}>
      <div style={{
        ...
        <div style={{ direction: 'ltr' }}>
          <Reveal>
            <div style={{
              ...
              <span style={{ color: 'var(--green)', opacity: 0.7 }}>{icon}</span>
              <p style={{
          ...
          <Reveal delay={0.1}>
            <h2 style={{
              fontFamily: 'var(--serif)', fontSize: 'clamp(32px, 3.8vw, 52px)',
              fontWeight: 500, lineHeight: 1.12, letterSpacing: '-0.02em',
              color: 'var(--text)', marginBottom: 28, maxWidth: 500,
            }}>{title}</h2>
          </Reveal>
          <Reveal delay={0.2}>
            <p style={{
        ...
        <Reveal delay={0.15}>
          <div style={{ direction: 'ltr' }}>
            <div style={{
              ...
              background: image ? 'none' : `linear-gradient(${135 + index * 30}deg, var(--green-muted), var(--cream-mid))`,
              ...
              {image ? (
                ...
                <div style={{
                  ...
                  <span style={{ color: 'var(--green)', opacity: 0.25 }}>
                    {icon}
                  </span>
                  <p style={{
                    fontSize: 13, color: 'var(--text-muted)', opacity: 0.6,
